...
public class admin_add_user extends HttpServlet {
   ...
   try{
       ...
       RequestDispatcher rd=request.getRequestDispatcher("/admin_add_user.html");
       if(y>0)
       {
            
            RequestDispatcher rd1=request.getRequestDispatcher("/adminhome.html");
                       rd1.include(request, response);
                       p.println("<font color='green' size='50px'><center>You added a new user successfully!!</center></font>");
        
       }
         else{
           
           rd.include(request, response);
           p.println("<font color='red' size='50px'><center>Sorry for inconvenience. Try again!!</center></font>");
           }
   }
