...
public class changeadmin_pass extends HttpServlet 
{
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       Connection con=DriverManager.getConnection(sc.getInitParameter("res_url"),"root","");
           ...
           if(a1.equals(a2)){
           y=st.executeUpdate(qu.updateadmin_pass(a3, a1));
           if(y>0){
               hs.invalidate();
               rd.include(request, response);
               p.println("<center><font color='green' size='50px'>Password Changed Successfully!!</center>");
               
           }
           else{
               RequestDispatcher rd1=request.getRequestDispatcher("/changeadmin_pass.html");
           ...
           p.println("<font color='red' size='50px'><center>Password not Changed</center></font>");
               ...
               RequestDispatcher rd2=request.getRequestDispatcher("/changeadmin_pass.html");
